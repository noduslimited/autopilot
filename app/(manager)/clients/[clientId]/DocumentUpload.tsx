...
export function DocumentUpload({ clientId, orgId }: { clientId: string; orgId: string }) {
  ...
  return (
    <div>
      <input ref={inputRef} type="file" onChange={handleFileChange} className="hidden" id="doc-upload" />
